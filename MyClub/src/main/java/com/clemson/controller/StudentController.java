...
public class StudentController {
	...
	public String login(@ModelAttribute("student") Student student, HttpServletRequest request) {
		Student studentLogin = studentService.getStudentByLogin(student.getIdcNumber(), student.getStudentPassword());
