...
<body class="gray-bg" background="img/5.jpg" style="background-size:cover;overflow:-Scroll;overflow-y:hidden">
    <div class="signinpanel text-center loginscreen" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-80" data-genuitec-path="/Clemson/src/main/webapp/WEB-INF/jsp/teacherLogin.jsp">
        <div class="row">
            <div class="col-sm-3">
            </div>
            <div class="col-md-6">
